...
- **시나리오 18장 (1막 12장 + 2막 6장)** — 컷신으로 이어지는 캠페인. 장마다 주 목표 1개 + 부 목표 2개가
  ...
  뒤로 갈수록 압박이 커진다. 잘 두는 봇 완주율로 3~8장 93% · 9~16장 79% · 17~24장 41%. 고양이 세 마리(샴냥·검은냥·뚱냥)가 2·4·6장 보상으로
...
- **속성 원정** — 맵 목록 맨 위. **사다리 셋**(잿불 길 → 서릿길 → 천둥 고개). 여섯 칸을 **목숨 하나로** 잇는다.
  ...
  **룬이 결과를 가른다** — 잘 두는 봇 기준 룬 없이 20~30%, 맞추면 50~100% (사다리별 표는 `docs/속성과카드.md`).
  잿불 길은 치즈냥의 룬이 거의 전부고, 천둥 고개는 룬 둘로 버릴 칸을 고르는 판이며, 서릿길은 얼음 도배가 답이다
...
내려왔다. 지금 봇 기준 잿불 길은 맞춘 덱 50~67% · 룬 없음 8~42% · 도배 최고 25% 다
(`docs/확장가이드.md` §21 에 사다리 셋의 표가 있다).
...
| 집냥이 (보통) | ×1.03 | ×1.0 | ×1.00 | ×1.0 | 100 · 100 · 100 · 100 · 0 · 0 · 0% |
