...
- **시나리오 18장 (1막 12장 + 2막 6장)** — 컷신으로 이어지는 캠페인. 장마다 주 목표 1개 + 부 목표 2개가
  ...
  뒤로 갈수록 압박이 커진다. 잘 두는 봇(`deck` · 시드 셋 × 3판) 구간 평균 완주율 1~8장 **89%** · 9~16장 **78%** · 17~24장 **40%** (`scenario-curve.test` 와 같은 방법 — Q 에서 다시 잼). **봇이 한 번도 못 깨는 장은 없다** — 검사가 장마다 바닥을 깐다. 12·18·24장이 22% 로 그 막에서 가장 어렵다. 고양이 세 마리(샴냥·검은냥·뚱냥)가 2·4·6장 보상으로
