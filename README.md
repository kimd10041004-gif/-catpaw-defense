...
- **훈련** — 도감에서 고양이마다 캣닢으로 영구 단계(3단계, 40·80·160)를 올린다. **가진 고양이만** 훈련한다(해금 또는 카드). 단계당 공격 +5%. 봇 기준(`node tools/balance-sim.mjs --growth 3 --seed 7`) 만렙(+15%)은 골목길·부엌·지붕·창고를 100% 클리어로 만들고 지하실·다락방은 여전히 못 깬다 — 앞 맵을 편하게 할 뿐 끝판을 대신 깨 주지 않는다
...
|---|---|---|---|---|---|
| 아깽이 (쉬움) | ×0.75 | ×1.5 | ×1.25 | ×1.0 | 100 · 100 · 100 · 100 · 100 · 38 · 100% |
| 집냥이 (보통) | ×1.03 | ×1.0 | ×1.00 | ×1.0 | 100 · 100 · 100 · 100 · 0 · 0 · 0% (`smart`) — **`deck` 봇은 100 · 100 · 100 · 100 · 56 · 44 · 22%** |
| 길냥이 (어려움) | ×1.35 | ×0.85 | ×1.00 | **×1.5** | 25 · 50 · 13 · 25 · 0 · 0 · 0% |
...
빨갰다). 창고는 안 움직였다 — `hpMul` 을 1.20 까지 올려도 `deck` 봇이 100% 라 이 봇으로는 손잡이가 없다. 온실은 절벽이
가팔라(1.80 이 0%, 1.70 이 56%) 1.74~1.78 이 전부 22% 인 자리를 골랐다. 사람에겐 다를 수 있다 — 봇 기준이다.
