...
export const FILES = {
  wrap: ['ui.js', 'main.js', 'game.js', 'render.js', 'domain/shop.js', 'domain/billing.js', 'domain/save.js', 'domain/growth.js', 'domain/specialGrowth.js', 'domain/daily.js', 'domain/tips.js', 'domain/cards.js', 'domain/expedition.js',
